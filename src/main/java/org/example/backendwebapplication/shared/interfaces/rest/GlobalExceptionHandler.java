package org.example.backendwebapplication.shared.interfaces.rest;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles invalid request arguments such as malformed path variables or payload values.
     *
    ...
    public ResponseEntity<?> handleRuntimeException(RuntimeException ex) {
        var applicationError = ApplicationError.unexpected(
                resolveMessageOrDefault("validation.unexpected.context", "global-exception-handler"),
