package org.example.backendwebapplication.shared.infraestructure.documentation.openapi.configuration;
...
public class OpenApiConfiguration {
     ...
     */
    @Bean
    public OpenAPI chapaTuRutaOpenAPI() {
        return new OpenAPI()
                .info(new Info()
