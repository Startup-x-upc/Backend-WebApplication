...
@Repository
public interface RideCandidateJpaRepository extends JpaRepository<RideCandidatePersistenceEntity, Long> {
    Optional<RideCandidatePersistenceEntity> findByCandidateId(String candidateId);
}
